...
QUESTIONS = [
    ...
    "Đúng không?",
    "Bạn có thể xác nhận thông tin này không?",
    "Điều này có phù hợp với hiểu biết của bạn không?",
    "Bạn diễn giải thông tin này như thế nào?",
    "Điều này có phù hợp với hiểu biết của bạn không?",
    "Bạn có thể xác nhận thông tin này không?",
    "Điều này có đúng không?",
    "Bạn có thể xác minh thông tin này không?",
    "Bạn có đồng ý với điều này không?",
    "Điều này có chính xác không?",
    "Bạn có thể xác nhận tuyên bố này không?",
    "Những chi tiết này có hợp lệ không?",
    "Điều này có đúng không?",                                                                                                                                                               
    "Những thông tin sau đây có đúng không? ",
    "Bạn có thể xác minh sự thật này không? ",
    "Bạn có đồng ý với khẳng định này không? ",
    "Những chi tiết này có chính xác không? ",
