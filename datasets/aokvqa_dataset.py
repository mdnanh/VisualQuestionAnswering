...
REASON_QUESTIONS = [
    ...
    "Và tại sao?",
    "Lý do là gì?",
    "Và bạn có thể cho tôi biết tại sao?",
    "Bạn có thể cho tôi biết tại sao?",
    "Bạn có thể cho tôi biết lý do?",
]
...
class AOKVQADataset(VQADataset):
    ...
    def process_text(self, ann):
        question = self.ggtranslate(ann["question"])
        ...
        answer = self.ggtranslate(answer)
