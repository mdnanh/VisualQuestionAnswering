...
QUESTIONS = [
    "Bạn nghĩ gì về câu trên? ",
    "Bạn có thể xác nhận tuyên bố này không? ",
    "Bạn diễn giải thông tin được cung cấp như thế nào? ",
    "Ý kiến của bạn về vấn đề này là gì? ",
    "Bạn có thể đưa ra quan điểm của mình về tuyên bố này không? ",
    "Bạn sẽ phản hồi như thế nào với tuyên bố được cung cấp? ",
    "Bạn nghĩ gì về chủ đề được đề cập? ",
    "Bạn có thể giải thích chi tiết ý tưởng này bằng tiếng Anh không? ",
    "Bạn có hiểu biết hoặc phản hồi nào về chủ đề này không? ",
    "Bạn nghĩ gì về tuyên bố được cung cấp? ",
    "Quan điểm của bạn về tuyên bố đưa ra là gì? ",
    "Bạn sẽ diễn giải nhận xét này như thế nào? ",
    "Bạn có thể cho ý kiến của mình về điều này không? ",
    "Bạn có thể chia sẻ hiểu biết của mình về điểm trên không? ",
    "Bạn có phiền xây dựng thêm về chủ đề này không? ",
    "Quan điểm của bạn về tuyên bố đưa ra là gì? ",
    "Bạn cảm thấy thế nào về thông tin được trình bày? ",
    "Bạn có thể cho ý kiến của mình về điều này không? ",
    "Quan điểm của bạn về tuyên bố này là gì? ",
    "Bạn có thể chia sẻ suy nghĩ của mình về tuyên bố được đề cập không? ",
    "Bạn sẽ diễn giải nhận xét trên như thế nào?",
    "Bạn có phiền chia sẻ những hiểu biết của mình về vấn đề này không?",
]
